...
python general_evaluation.py --measure nmi --ground ./groundtruth/dolphin/dolphin.cmty --detected ./output/dolphin/dolphin.cmty --algorithm ours&
...
python general_evaluation.py --measure nmi --ground ./groundtruth/football/football.cmty --detected ./output/football/football.cmty --algorithm ours&
python general_evaluation.py --measure f1 --ground ./groundtruth/football/football.cmty --detected ./output/football/football.cmty --algorithm ours&
python general_evaluation.py --measure nmi --ground ./groundtruth/karate/karate.cmty --detected ./output/karate/karate.cmty --algorithm ours&
python general_evaluation.py --measure f1 --ground ./groundtruth/karate/karate.cmty --detected ./output/karate/karate.cmty --algorithm ours&
python general_evaluation.py --measure nmi --ground ./groundtruth/mexican/mexican.cmty --detected ./output/mexican/mexican.cmty --algorithm ours&
python general_evaluation.py --measure f1 --ground ./groundtruth/mexican/mexican.cmty --detected ./output/mexican/mexican.cmty --algorithm ours&
python general_evaluation.py --measure nmi --ground ./groundtruth/polbooks/polbooks.cmty --detected ./output/polbooks/polbooks.cmty --algorithm ours&
python general_evaluation.py --measure f1 --ground ./groundtruth/polbooks/polbooks.cmty --detected ./output/polbooks/polbooks.cmty --algorithm ours&
python general_evaluation.py --measure nmi --ground ./groundtruth/strike/strike.cmty --detected ./output/strike/strike.cmty --algorithm ours&
python general_evaluation.py --measure f1 --ground ./groundtruth/strike/strike.cmty --detected ./output/strike/strike.cmty --algorithm ours&
python general_evaluation.py --measure nmi --ground ./groundtruth/railway/railway.cmty --detected ./output/railway/railway.cmty --algorithm ours&
python general_evaluation.py --measure f1 --ground ./groundtruth/railway/railway.cmty --detected ./output/railway/railway.cmty --algorithm ours&
